...
const VENUE_FIELDS =
  "id, name, neighborhood, city, latitude, longitude, avg_spend_aed, google_maps_url, hero_video_url, menu_url, phone, booking_phone, booking_url, website, instagram_url, tiktok_url, opening_hours, is_aesthetic, age_restriction, category, description";
